...
export class Backend implements backendInterface {
    ...
    async addInitialFAQEntries(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addInitialFAQEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFAQEntries(): Promise<Array<FAQEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFAQEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFAQAnswer(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFAQAnswer(arg0);
